...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net rst_zynq_ps_100M_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins rst_gen/peripheral_aresetn]
  connect_bd_net -net zynq_ps_FCLK_CLK0 [get_bd_pins rst_gen/slowest_sync_clk] [get_bd_pins zynq_ps/FCLK_CLK0]
  connect_bd_net -net zynq_ps_FCLK_CLK1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins zynq_ps/FCLK_CLK1] [get_bd_pins zynq_ps/M_AXI_GP0_ACLK]
  connect_bd_net -net zynq_ps_FCLK_RESET0_N [get_bd_pins rst_gen/ext_reset_in] [get_bd_pins zynq_ps/FCLK_RESET0_N]
