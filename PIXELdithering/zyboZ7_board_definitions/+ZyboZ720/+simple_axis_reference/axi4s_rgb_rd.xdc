...
##Constraint for hdmi pixel clock
...
##LEDs
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports plocked_led]
set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS33} [get_ports axi_locked_led]
set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports uf_led]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports of_led]
